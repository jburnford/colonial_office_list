...
COLONIES = [
    # Redirects to Leeward Islands
    {"name": "ANTIGUA", "start": 1308, "end": 1310, "redirect": True},
    {"name": "ANGUILLA", "start": 1311, "end": 1313, "redirect": True},

    # Full colonies
    {"name": "BAHAMAS", "start": 1314, "end": 1576},
    {"name": "BARBADOS", "start": 1577, "end": 1813},
    {"name": "BERMUDAS", "start": 1583, "end": 1813},  # Check this overlaps with Barbados - need to verify
    {"name": "BRITISH_HONDURAS", "start": 1817, "end": 1819},
    ...
    {"name": "DOMINICA", "start": 6183, "end": 6186, "redirect": True},
    ...
    {"name": "GRENADA", "start": 7020, "end": 7025},
    ...
    {"name": "NEVIS", "start": 11295, "end": 11297, "redirect": True},
    {"name": "NEWFOUNDLAND", "start": 11298, "end": 11961},
    {"name": "NEW_SOUTH_WALES", "start": 11962, "end": 12581},
    {"name": "NEW_ZEALAND", "start": 12582, "end": 13152},
    {"name": "QUEENSLAND", "start": 13153, "end": 13504},
    {"name": "SIERRA_LEONE", "start": 13505, "end": 13510},
    ...
    {"name": "TOBAGO", "start": 15013, "end": 15016},
    ...
    {"name": "VIRGIN_ISLANDS", "start": 16377, "end": 16380, "redirect": True},
    ...
    # ST. LUCIA appears later as part of WINDWARD but also standalone at 18095
]
...
def extract_colony(colony_info):
    ...
    redirect = colony_info.get("redirect", False)
    ...
    if redirect:
        ...
        metadata["notes"] = "Redirect to another colony section"
...
def main():
    ...
    print("=" * 80)
    print(f"Total colonies extracted: {successful}")
    ...
    with open(REPORT_FILE, 'w', encoding='utf-8') as f:
        ...
        f.write("1. Read the entire 1877 OCR results file\n")
        f.write("2. Manually identified colony section headers\n")
        f.write("3. Determined section boundaries by reading content\n")
        f.write("4. Cross-referenced with 1867 and 1878 lists\n")
        ...
        f.write("\n## Notes\n\n")
        f.write("- Some colonies (Antigua, Anguilla, Dominica, Nevis, Virgin Islands) are redirect entries pointing to their parent colony (Leeward Islands)\n")
        f.write("- The Leeward Islands section contains all sub-colonies: Antigua, Montserrat, St. Christopher, Nevis, Dominica, Virgin Islands\n")
        f.write("- The Windward Islands section contains: Barbados, Grenada, St. Vincent, St. Lucia, Tobago\n")
        f.write("- Some colonies appear to have overlapping or unclear boundaries - these were resolved through careful reading\n")
        f.write("- Part III (Emigration) begins at line 18253, marking the end of colony sections\n")
