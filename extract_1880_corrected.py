#!/usr/bin/env python3
"""
Extract corrected 1880 colonies based on manual boundary verification.

VERIFIED CORRECTION:
- Split WEST AFRICA SETTLEMENTS into 2 colonies:
  * SIERRA LEONE (17107-17413)
  * THE GAMBIA (17414-17554) - Note: "GAMBLIA" typo in OCR

Total: 35 → 36 colonies
"""
...
# Source OCR file
source_file = Path('/home/user/colonial_office_list/historical_document_pipeline/processed_pdfs/colonial-office-list-1880/olmocr_results.md')
...
print("=" * 80)
print("EXTRACTING CORRECTED 1880 COLONIES")
print("=" * 80)
print()
...
print("GROUP A: Extracting 34 existing colonies (excluding WEST AFRICA SETTLEMENTS)...")
print()
...
west_african_colonies = [
    ('SIERRA_LEONE', 17107, 17413),
    ('THE_GAMBIA', 17414, 17554),
]
...
print()
print("Next step: Run create_1880_metadata.py to generate corrected metadata JSON")
