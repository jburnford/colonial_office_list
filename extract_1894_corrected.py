#!/usr/bin/env python3
"""
Extract corrected 1894 colonies based on manual boundary verification.

VERIFIED CORRECTIONS:
- BRITISH NEW GUINEA: Was 1,663 lines (3689-5352) → Fixed to 87 lines (3690-3776)
- DOMINION OF CANADA: 2,508 lines (3777-6284) - COMPLETELY MISSING from metadata!
- CAPE OF GOOD HOPE: Was 1,092 lines (7298-8389) → Fixed to 2,105 lines (6285-8389)
  - Original extraction missed main colony intro (6285-7297)

Total: 45 → 47 colonies (+2 recovered)
"""
...
# Source OCR file
source_file = Path('/home/user/colonial_office_list/historical_document_pipeline/processed_pdfs/colonial-office-list-1894/olmocr_results.md')
...
print("=" * 80)
print("EXTRACTING CORRECTED 1894 COLONIES")
print("=" * 80)
print()
...
print("GROUP A: Extracting 43 existing colonies (excluding contaminated files)...")
print()
...
print()
print("=" * 80)
print("GROUP B: Re-extracting 4 corrected colonies...")
print("=" * 80)
print()

# Define the corrected colonies
corrected_colonies = [
    ('BRITISH_NEW_GUINEA', 3690, 3776, 'Was contaminated (1,663 lines containing 3 colonies). Fixed to actual colony content.'),
    ('DOMINION_OF_CANADA', 3777, 6284, 'COMPLETELY MISSING from metadata! Recovered 2,508 lines.'),
    ('CAPE_OF_GOOD_HOPE', 6285, 8389, 'Was missing main section (started at 7298). Fixed to include full colony from 6285.'),
]
...
print(f"Recovered colonies: 2 (DOMINION OF CANADA + Cape main section)")
print(f"Final total: {len(extracted_colonies)} colonies")
print()
print(f"Output directory: {output_dir}")
print()
print("Next step: Run create_1894_metadata.py to generate corrected metadata JSON")
