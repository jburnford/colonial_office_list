#!/usr/bin/env python3
"""
Extract corrected 1896 colonies based on manual boundary verification.

VERIFIED CORRECTIONS:
- BRITISH NEW GUINEA: Was 2,235 lines (4489-6724) → Fixed to 106 lines (4490-4595)
- DOMINION OF CANADA: 3,086 lines (4596-7681) - COMPLETELY MISSING from metadata!
- CAPE OF GOOD HOPE: 2,068 lines (7682-9749) - Already correct in metadata

Total: 44 → 45 colonies (+1 recovered)
"""
...
# Source OCR file
source_file = Path('/home/user/colonial_office_list/historical_document_pipeline/processed_pdfs/colonial-office-list-1896/olmocr_results.md')
...
print("=" * 80)
print("EXTRACTING CORRECTED 1896 COLONIES")
print("=" * 80)
print()
...
print("GROUP A: Extracting 43 existing colonies (excluding contaminated British New Guinea)...")
print()
...
corrected_colonies = [
    ('BRITISH_NEW_GUINEA', 4490, 4595, 'Was contaminated (2,235 lines containing 2 colonies). Fixed to actual colony content.'),
    ('DOMINION_OF_CANADA', 4596, 7681, 'COMPLETELY MISSING from metadata! Recovered 3,086 lines.'),
]
...
print()
print("Next step: Run create_1896_metadata.py to generate corrected metadata JSON")
