#!/usr/bin/env python3
"""
Extract corrected 1898 colonies based on manual boundary verification.

VERIFIED CORRECTIONS:
- BRITISH NEW GUINEA: Was 847 lines (3803-4650) → Fixed to 90 lines (3804-3893)
- DOMINION OF CANADA: 2,866 lines (3894-6759) - COMPLETELY MISSING from metadata!
- CAPE OF GOOD HOPE: 2,209 lines (6759-8967) - Already correct in metadata

Total: 51 → 52 colonies (+1 recovered)
"""
...
# Source OCR file
source_file = Path('/home/user/colonial_office_list/historical_document_pipeline/processed_pdfs/colonial-office-list-1898/olmocr_results.md')
...
print("=" * 80)
print("EXTRACTING CORRECTED 1898 COLONIES")
print("=" * 80)
print()
...
print("GROUP A: Extracting 50 existing colonies (excluding contaminated British New Guinea)...")
print()
...
corrected_colonies = [
    ('BRITISH_NEW_GUINEA', 3804, 3893, 'Was contaminated (847 lines containing 2 colonies). Fixed to actual colony content.'),
    ('DOMINION_OF_CANADA', 3894, 6759, 'COMPLETELY MISSING from metadata! Recovered 2,866 lines.'),
]
...
print()
print("Next step: Run create_1898_metadata.py to generate corrected metadata JSON")
