#!/usr/bin/env python3
"""
Extract corrected 1899 colonies based on manual boundary verification.

VERIFIED CORRECTIONS:
- BRITISH NEW GUINEA: Was 1,980 lines (3949-5929) → Fixed to 127 lines (3950-4076)
- DOMINION OF CANADA: 2,925 lines (4077-7001) - COMPLETELY MISSING from metadata!
- CAPE OF GOOD HOPE: 2,478 lines (7001-9478) - Already correct in metadata

Total: 45 → 46 colonies (+1 recovered)
"""
...
# Source OCR file
source_file = Path('/home/user/colonial_office_list/historical_document_pipeline/processed_pdfs/colonial-office-list-1899/olmocr_results.md')
...
print("=" * 80)
print("EXTRACTING CORRECTED 1899 COLONIES")
print("=" * 80)
print()
...
print("GROUP A: Extracting 44 existing colonies (excluding contaminated British New Guinea)...")
print()
...
corrected_colonies = [
    ('BRITISH_NEW_GUINEA', 3950, 4076, 'Was contaminated (1,980 lines containing 2 colonies). Fixed to actual colony content.'),
    ('DOMINION_OF_CANADA', 4077, 7001, 'COMPLETELY MISSING from metadata! Recovered 2,925 lines.'),
]
...
print()
print("Next step: Run create_1899_metadata.py to generate corrected metadata JSON")
