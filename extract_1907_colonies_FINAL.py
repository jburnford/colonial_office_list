#!/usr/bin/env python3
"""
Extract Colonial Office List 1907 - All Colonies - CORRECTED FINAL VERSION
Includes TRANSVAAL (misspelled as "TRANSAAL" in source)
"""
...
# Manually verified colony boundaries - CORRECTED
colonies = [
    ...
    ("LABUAN", 31643, 32307, "LABUAN"),  # Includes Brunei and Federated Malay States content
    ("TRANSVAAL", 32308, 33122, "TRANSVAAL"),  # Misspelled as "TRANSAAL" in source
...
metadata = {
    ...
    "extraction_method": "manual_boundary_identification_comprehensive_corrected",
    "extraction_date": datetime.now().strftime("%Y-%m-%d"),
    "total_colonies": len(colonies),
    "notes": [
        "Complete manual re-parsing of 1907 Colonial Office List - CORRECTED VERSION",
        ...
        "TRANSVAAL misspelled as 'TRANSAAL' in source document (line 32308)",
        "TRANSVAAL granted responsible government in December 1906 but still listed",
        "STRAITS SETTLEMENTS and LABUAN are separate sections (LABUAN includes Malay States content)",
